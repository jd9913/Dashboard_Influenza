...
let labelED = ['ED pos/susp influenza'];
let labelVent = ['Vent pos/susp influenza'];
let labelInpt = ['inpatients pos/susp influenza'];
let labelIcu = ['ICU pos/susp influenza'];
